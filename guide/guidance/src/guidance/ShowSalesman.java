...
public class ShowSalesman extends JFrame {
	...
	public ShowSalesman() {
		...
		JLabel lblNewLabel = new JLabel("公园的环游短路径是：");
		...
		coper.getWords("salesman.txt");

		JLabel label_1 = new JLabel(coper.result[0]);
